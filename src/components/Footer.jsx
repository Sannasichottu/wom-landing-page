    ...
    <div className='footer'>
        <div className='bulb'>
            ...
            <div className='footer-text'>
                ...
                <a href="/" style={{marginLeft:'40px'}}>Get Started</a>
            </div>
        </div>
        ...
        <div className='footer-menu'>
            ...
            <ul className='footer-inner-nav'>
                ...
                <li><a href=" "> <img style={{width:"200px"}} src="https://play.google.com/intl/en_us/badges/static/images/badges/en_badge_web_generic.png" alt="" /></a></li>
                <li><a href=" "> <img style={{width:"180px", height:'52px'}} src="https://www.incometax.gov.in/iec/foportal/sites/default/files/2020-02/app-store.png" alt="" /></a></li>
